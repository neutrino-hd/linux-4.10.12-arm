 ...
 *
 *
 * Date:           Generated on              Wed Jul 16 11:41:59 2014
 ...
 ***************************************************************************/
#define BCHP_PCIE_0_DMA_TX_FIRST_DESC_L_ADDR_LIST0 0x00464400 /* Tx Descriptor List0 First Descriptor lower Address */
#define BCHP_PCIE_0_DMA_TX_FIRST_DESC_U_ADDR_LIST0 0x00464404 /* Tx Descriptor List0 First Descriptor Upper Address */
#define BCHP_PCIE_0_DMA_TX_FIRST_DESC_L_ADDR_LIST1 0x00464408 /* Tx Descriptor List1 First Descriptor Lower Address */
#define BCHP_PCIE_0_DMA_TX_FIRST_DESC_U_ADDR_LIST1 0x0046440c /* Tx Descriptor List1 First Descriptor Upper Address */
#define BCHP_PCIE_0_DMA_TX_SW_DESC_LIST_CTRL_STS 0x00464410 /* Tx Software Descriptor List Control and Status */
#define BCHP_PCIE_0_DMA_TX_WAKE_CTRL             0x00464414 /* Tx Wake Control */
#define BCHP_PCIE_0_DMA_TX_ERROR_STATUS          0x00464418 /* Tx Engine Error Status */
#define BCHP_PCIE_0_DMA_TX_LIST0_CUR_DESC_L_ADDR 0x0046441c /* Tx List0 Current Descriptor Lower Address */
#define BCHP_PCIE_0_DMA_TX_LIST0_CUR_DESC_U_ADDR 0x00464420 /* Tx List0 Current Descriptor Upper Address */
#define BCHP_PCIE_0_DMA_TX_LIST0_CUR_BYTE_CNT    0x00464424 /* Tx List0 Current Descriptor Byte Count */
#define BCHP_PCIE_0_DMA_TX_LIST1_CUR_DESC_L_ADDR 0x00464428 /* Tx List1 Current Descriptor Lower Address */
#define BCHP_PCIE_0_DMA_TX_LIST1_CUR_DESC_U_ADDR 0x0046442c /* Tx List1 Current Descriptor Upper Address */
#define BCHP_PCIE_0_DMA_TX_LIST1_CUR_BYTE_CNT    0x00464430 /* Tx List1 Current Descriptor Byte Count */
#define BCHP_PCIE_0_DMA_RX_FIRST_DESC_L_ADDR_LIST0 0x00464434 /* Rx Descriptor List0 First Descriptor Lower Address */
#define BCHP_PCIE_0_DMA_RX_FIRST_DESC_U_ADDR_LIST0 0x00464438 /* Rx Descriptor List0 First Descriptor Upper Address */
#define BCHP_PCIE_0_DMA_RX_FIRST_DESC_L_ADDR_LIST1 0x0046443c /* Rx Descriptor List1 First Descriptor Lower Address */
#define BCHP_PCIE_0_DMA_RX_FIRST_DESC_U_ADDR_LIST1 0x00464440 /* Rx Descriptor List1 First Descriptor Upper Address */
#define BCHP_PCIE_0_DMA_RX_SW_DESC_LIST_CTRL_STS 0x00464444 /* Rx Software Descriptor List Control and Status */
#define BCHP_PCIE_0_DMA_RX_WAKE_CTRL             0x00464448 /* Rx DMA Wake Control */
#define BCHP_PCIE_0_DMA_RX_ERROR_STATUS          0x0046444c /* Rx Engine Error Status */
#define BCHP_PCIE_0_DMA_RX_LIST0_CUR_DESC_L_ADDR 0x00464450 /* Rx List0 Current Descriptor Lower Address */
#define BCHP_PCIE_0_DMA_RX_LIST0_CUR_DESC_U_ADDR 0x00464454 /* Rx List0 Current Descriptor Upper Address */
#define BCHP_PCIE_0_DMA_RX_LIST0_CUR_BYTE_CNT    0x00464458 /* Rx List0 Current Descriptor Byte Count */
#define BCHP_PCIE_0_DMA_RX_LIST1_CUR_DESC_L_ADDR 0x0046445c /* Rx List1 Current Descriptor Lower address */
#define BCHP_PCIE_0_DMA_RX_LIST1_CUR_DESC_U_ADDR 0x00464460 /* Rx List1 Current Descriptor Upper address */
#define BCHP_PCIE_0_DMA_RX_LIST1_CUR_BYTE_CNT    0x00464464 /* Rx List1 Current Descriptor Byte Count */
#define BCHP_PCIE_0_DMA_DMA_DEBUG_OPTIONS_REG    0x00464468 /* DMA Debug Options Register */
#define BCHP_PCIE_0_DMA_READ_CHANNEL_ERROR_STATUS 0x0046446c /* Read Channel Error Status */
